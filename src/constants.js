const allocateTo1 = ["function allocateTo(address to, uint amount)"];
const mint1 = ["function mint(address to, uint amount)"];
const mint2 = ["function mint(uint amount)"];
export const abis = { allocateTo1, mint1, mint2 };
